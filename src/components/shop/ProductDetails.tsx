...
const ProductDetails = ({ id }: ID) => {
  ...
  return (
    <div className="p-4 md:p-6 w-[340px] md:w-[700px] lg:w-[750px] flex flex-col justify-center md:flex-row md:items-center gap-5 tracking-wider">
      ...
      <div className="flex gap-2 flex-col w-[w-320px] md:w-[350px] lg:w-[350px]">
        <h2 className="text-base md:text-2xl font-fontMed md:font-fontBold text-wrap text-TX-main">
          {product?.name}
        </h2>
