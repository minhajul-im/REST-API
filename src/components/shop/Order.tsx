    ...
    <React.Fragment>
      {isSuccess ? (
        ...
        <form
          ...
          className="w-[320px] md:w-[450px] lg:[520px] my-6 p-2 md:p4 transition-all duration-200 tracking-wider">
          <Input
            name="name"
            text="John David"
            require={true}
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="w-full px-4 py-2 text-TX-main border border-TX-soft bg-BG-soft rounded-md focus:outline-none focus:ring-2 focus:ring-[#3586ff]"></textarea>
          </div>
          ...
          <button
            ...
            className={`w-full ${
              active
                ...
                : "bg-gradient-to-r from-[#335c99] to-[#1a2438]"
            } text-white py-2 rounded-lg mx-auto block focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 mb-2 transition-all duration-150`}>
