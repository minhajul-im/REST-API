...
import "./Navbar.css";
import { LINK, LINKS, logo } from "../../constant/mock-data";
        ...
        <div className="hidden space-x-6 md:flex">
          {LINKS.map((link: LINK, idx: number) => (
            <a
              ...
              className={`text-sm mx-4 font-fontMed ${
                idx !== 0 ? "border-l-2 border-TX-dark pl-2" : ""
            ...
            {LINKS.map((link: LINK, idx: number) => (
              <motion.li
                ...
                <a
                  ...
                  className={`text-sm block p-4 font-fontMed tracking-tighter uppercase
